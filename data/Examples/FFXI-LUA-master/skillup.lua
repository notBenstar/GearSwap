...
user_settings = {
    user_spells = {
        ...
        Geomancy = T{'Indi-Refresh','Indi-Regen', 'Geo-Poison', 'Geo-Voidance'},
        Enhancing = T{'Barfira', 'Barthundera', 'Barstonra', 'Refresh' },
        Ninjutsu = T{'Hojo: Ni', 'Hyoton: Ni', 'Katon: Ni'},
        Singing = T{},
        Blue = T{},
        Summoning = T{'Fire Spirit', 'Ice Spirit', 'Water Spirit', 'Air Spirit'}},

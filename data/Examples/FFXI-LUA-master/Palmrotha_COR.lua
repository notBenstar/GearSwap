function get_sets()
        ...
        sets.Idle.DT = {main="Terra's Staff",sub="Umbra strap", 
                                head="Rabid Visor",neck="Loricate Torque +1", ear1="Etiolation earring", ear2="Handler's earring +1",
                                        body="Emet Harness",hands="Garden Bangles",ring1="Dark ring",ring2="Succor ring",
                                        back="Solemnity Cape",waist="Flume belt +1",legs="Osmium Cuisses",feet = "Herculean Boots" }
										
		sets.Idle.Cleave = { 
										head="Rabid Visor",neck="Loricate Torque +1", ear1="Etiolation earring", ear2="Handler's earring +1",
                                        body="Emet Hareness",hands="Garden Bangles",ring1="Dark ring",ring2="Succor ring",
                                        back="Mecistopins mantle",waist="Flume belt +1",legs="Osmium Cuisses",feet = "Herculean Boots" }								
        --TP Sets--
        sets.TP = {}
           ...
           sets.TP.index = {'Standard', 'DT', 'DTAccuracy'}
				...
				sets.TP.Standard = {  
                                    ...
                                    body="Rawhide Vest",hands="Taeon Gloves",ring1="Enlivened Ring",ring2="Oneiros Ring",
                                    back="Grounded Mantle",waist="Sentry Belt",legs="Obatala Subligar",feet = "Herculean Boots" }
                                                       
                                                       
                sets.TP.DT = { 
                              head="Dampening Tam",neck="Loricate Torque +1", ear1="Genmei Earring", ear2="Heartseeker Earring",
                              body="Emet harness +1",hands="Taeon Gloves",ring1="Dark ring",ring2="Oneiros Ring",
                ...
                sets.TP.DTAccuracy = { 
									  ...
									  body="Emet harness +1",hands="Taeon Gloves",ring1="Dark ring",ring2="Mars's ring",
                                      back="Solemnity Cape",waist="Flume belt +1",legs="Obatala Subligar",feet = "Herculean Boots" }
       ...
       --Weaponskill Sets--
        ...
        sets.SavageBlade.Attack = {
                                          ...
                                          body="Rawhide Vest",hands="Taeon Gloves",ring1="Petrov Ring",ring2="Oneiros Ring",
                                          back="Buquwik Cape",waist="Prosilio Belt",legs="Obatala Subligar",feet = "Herculean Boots" }
        ...
        sets.SanguineBlade = {
                                 ...
                                 body="Rawhide Vest",hands="Taeon Gloves", ring1="Acumen Ring", ring2 ='Arvina Ringlet', waist ="Eschan Stone",
                                 back="Cornflower cape",legs="Obatala Subligar",feet="Weatherspoon souliers +1" }
        ...
        sets.VorpalBlade = {
                                          ...
                                          body="Rawhide Vest",hands="Taeon Gloves",ring1="Petrov ring",ring2="Oneiros Ring",
                                          back="Lupine Cape",waist="Dynamic belt",legs="Quiahuiz leggings",feet = "Herculean Boots" }						 
		...
		sets.Leaden ={ ammo ="Orichalcum bullet", head="Pixie Hairpin +1",
							neck="Hunai Collar",   ear2="Friomisi earring", ear1="Hecate's Earring",
							body="Rawhide Vest",    hands="Taeon Gloves",    ring1="Acumen Ring", ring2 ='Arvina Ringlet', waist ="Eschan Stone",
		...
		sets.LastStand = {ammo ="Orichalcum bullet", head="Adhemar Bonnet",neck="Fotia gorget",ear1="Heartseeker Earring",ear2="Neritic Earring",
                                          body="Rawhide Vest",hands="Taeon Gloves",ring1="Longshot Ring",ring2="Arvina Ringlet",
                                          back="Lupine Cape",waist="Fotia Belt",legs="Obatala Subligar",feet = "Herculean Boots" }
										  
		--Ranged Attack ---
			sets.Ranged = {}
			sets.Ranged.RangedAttack =  { ammo ="Orichalcum bullet", head="Dampening Tam",
							neck="Hunai Collar",   ear2="Heartseeker Earring", ear1="Neritic Earringsa",
							body="Rawhide Vest",hands="Taeon Gloves", ring1="Longshot Ring",ring2="Arvina Ringlet", waist ="Eschan Stone",
							back="Gunslinger's Cape",   legs="Obatala Subligar",  feet = "Herculean Boots" }
        ...
        sets.Utility.MB = {head="Helios Band",body="Rawhide Vest",ear1="Static Earring",ring1="Locus Ring",ring2="Mujin Band"}
        ...
        sets.Utility.Stoneskin = {head="Haruspex hat",neck="Stone Gorget",ear1="Loquac. earring",ear2="Earthcry earring",
                                                          ...
                                                          back="Swith cape",waist="Siegel sash",legs="Haven hose",feet = "Herculean Boots" }
        ...
        sets.Utility.Phalanx = {head="Haruspex hat",neck="Colossus's torque",ear1="Loquac. earring",ear2="Augment. earring",
                                                    body="Assim. jubbah +1",hands="Ayao's gages",ring1="Prolix ring",
                                                        back="Swith cape",waist="Pythia sash +1",legs="Portent pants",feet = "Herculean Boots" }
                                                       
        sets.Utility.Steps = {
							head="Dampening Tam", body="Rawhide Vest", hands="Rawhide Gloves",legs=="Obatala Subligar", feet ="Herculean Boots",  neck="Subtlety Spec.",
							waist="Chaac Belt", left_ear="Heartseeker Earring",right_ear="Heartseeker Earring",  left_ring="Yacuruna Ring",  right_ring="Oneiros Ring",  back="Grounded Mantle",}
        ...
        sets.JA.PhantomRoll = {head="Commodore Tricorne +2",neck="Loricate Torque +1", ear1="Etiolation earring", ear2="Genmei Earring",
                              body="Emet Hareness",hands="Chasseur's Gants",ring1="Luzaf's Ring",ring2="Barataria Ring",
                              back="Camulus's Mantle",waist="Flume belt +1",legs="Osmium Cuisses",feet = "Herculean Boots" }

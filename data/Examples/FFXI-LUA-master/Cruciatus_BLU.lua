function get_sets()
        ...
        sets.Idle.DT = {
                ...
                feet = {
                        ...
                        augments = {"CHR+6", "STR+14", '"Refresh"+1', 'Mag. Acc.+14 "Mag.Atk.Bns."+14'}
                }
        }
        ...
        sets.SavageBlade.Attack = {
                ...
                feet = {
                        name = "Herculean Boots",
                        augments = {"Attack+29", "Weapon skill damage +2%", "STR+2", "Accuracy+10"}
                }
        }
...
function midcast(spell, act)
        ...
        elseif
                spell.english == "Vertical Cleave" or spell.english == "Death Scissors" or
                        ...
                        spell.english == "Heavy Strike" or
                        spell.english == "Sinker Drill"
         then
        ...
        elseif
                spell.english == "Gates of Hades" or spell.english == "Lunge" or spell.english == "Swipe" or
                        ...
                        spell.english == "Anvil Lightning" or
                        spell.english == "Blinding Fulgor" or
                        spell.english == "Entomb" or
                        spell.english == "Palling Salvo" or
                        spell.english == "Scouring Spate" or
                        spell.english == "Searing Tempest" or
                        spell.english == "Silent Storm" or
                        spell.english == "Spectral Floe" or
                        spell.english == "Blazing Bound" or
                        spell.english == "Frightful Roar" or
                        spell.english == "Infrasonics" or
                        spell.english == "Chaotic Eye" or
                        spell.english == "Auroral Drape" or
        ...
        elseif
                spell.english == "Sheep Song" or spell.english == "Blood Drain" or spell.english == "Soporific" or
                        spell.english == "Soud Blast" or
                        spell.english == "Chaotic Eye" or
                        ...
                        spell.english == "Awful Eye" or
                        spell.english == "Blood Saber" or
                        spell.english == "Jettatura" or
                        spell.english == "Frightful Roar" or
                        spell.english == "Filamented Hold" or
                        spell.english == "Cold Wave" or
                        spell.english == "Light of Penance" or
                        spell.english == "1000 Needles" or
                        spell.english == "Feather Tickle" or
                        spell.english == "Yawn" or
                        spell.english == "Voracious Trunk" or
                        spell.english == "Infrasonics" or
                        spell.english == "Sandspray" or
                        spell.english == "Corrosive Ooze" or
                        spell.english == "Enervation" or
                        spell.english == "Lowing" or
                        spell.english == "Triumphant Roar" or
                        spell.english == "Actinic Burst" or
                        spell.english == "Osmosis" or
                        spell.english == "Cimicine Discharge" or
                        spell.english == "Demoralizing Roar" or
                        spell.english == "Auroral Drape" or
                        spell.english == "Dream Flower" or
                        spell.english == "Reaving Wind" or
                        spell.english == "Mortal Ray" or
                        spell.english == "Absolute Terror" or
                        spell.english == "Blistering Roar"
         then
                equip(sets.BlueMagic.Debuff)
        elseif
                spell.english == "Magic Fruit" or spell.english == "Plenilune Embrace" or spell.english == "Wild Carrot" or
                        spell.english == "Pollen" or
                        spell.english == "Cure III" or
                        spell.english == "Cure IV" or
                        spell.english == "White Wind"
         then
                equip(sets.BlueMagic.BlueCure)
                if
                        spell.target.name == player.name and string.find(spell.english, "Magic Fruit") or
                                string.find(spell.english, "Plenilune Embrace") or
                                string.find(spell.english, "Wild Carrot") or
                                string.find(spell.english, "Cure III") or
                                string.find(spell.english, "Cure IV")
                 then
                        equip(sets.BlueMagic.BlueCure)
                end
        elseif
                spell.english == "Head Butt" or spell.english == "Sudden Lunge" or spell.english == "Tourbillion" or
                        spell.english == "Saurian Slide" or
                        spell.english == "Sweeping Gouge" or
                        spell.english == "Frypan"
         then
                equip(sets.BlueMagic.PhysStun)
        elseif
                spell.english == "MP Drainkiss" or spell.english == "Digest" or spell.english == "Blood Saber" or
                        spell.english == "Blood Drain" or
                        spell.english == "Osmosis" or
                        spell.english == "Magic Barrier" or
                        spell.english == "Diamondhide" or
                        spell.english == "Metallic Body"
         then
        ...
        elseif
                spell.english == "Erratic Flutter" or spell.english == "Nat. Meditation" or spell.english == "Uproot" or
                        spell.english == "Saline Coat" or
                        spell.english == "Barrier Tusk" or
                        spell.english == "Metallic Body" or
                        spell.english == "Diamondhide" or
                        spell.english == "Reactor Cool" or
                        spell.english == "Plasma Charge" or
                        spell.english == "Magic Barrier" or
                        spell.english == "Orcish Counterstance" or
                        spell.english == "Pyric Bulwark" or
                        spell.english == "Carcharian Verve" or
                        spell.english == "Battery Charge" or
                        spell.engligh == "Refresh" or
                        spell.english == "Occultation"
         then
                equip(sets.BlueMagic.Buff)
        elseif
                spell.english == "Poison Breath" or spell.english == "Magnetite Cloud" or
                        spell.english == "Self Destruct" or
                        spell.english == "Hecatomb Wave" or
                        spell.english == "Radiant Breath" or
                        spell.english == "Flying Hip Press" or
                        spell.english == "Bad Breath" or
                        spell.english == "Frost Breath" or
                        spell.english == "Heat Breath" or
                        spell.english == "Final Sting" or
                        spell.english == "Thunder Breath" or
                        spell.english == "Wind Breath"
         then
                equip(sets.BlueMagic.Breath)
        elseif
                spell.english == "Cocoon" or spell.english == "Mighty Guard" or spell.english == "Harden Shell" or
                        spell.english == "Animating Wail" or
                        spell.english == "Battery Charge" or
                        spell.english == "Nat. Meditation" or
                        spell.english == "Carcharian Verve" or
                        spell.english == "O. Counterstance" or
                        spell.english == "Barrier Tusk" or
                        spell.english == "Saline Coat" or
                        spell.english == "Regeneration" or
                        spell.english == "Erratic Flutter"
         then
                if buffactive["Diffusion"] then
                        equip(sets.JA.Diffusion)
                end

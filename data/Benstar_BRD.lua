function get_sets()
    ...
    sets.Rudra = {    
		...
		left_ring={ name="Metamor. Ring +1", augments={'Path: A',}},
		back={ name="Intarabus's Cape", augments={'STR+20','Accuracy+20 Attack+20','Weapon skill damage +10%','Damage taken-5%',}},
	}
...
function calculate_duration(name)
    ...
    if string.find(name,'Paeon') and player.equipment.head == "Bihu Roundlet +3" then mult = mult + 0.1 end

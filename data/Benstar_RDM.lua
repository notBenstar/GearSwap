...
function get_sets()
	...
	sets.Idle.Standard = {
		...
		legs={ name="Chironic Hose", augments={'Crit.hit rate+3','Mag. Acc.+10','"Refresh"+1',}},
	...
	sets.TP.index = {"Standard", "EnSpell", "EnSpell1Damage"}--"LowHaste", "LowHasteEnSpell", "EnSpell1Damage", "SubtleBlow"}
	...
	sets.Enhancing.Duration = {
		main={ name={ name="Colada", augments={'Enh. Mag. eff. dur. +3','STR+4','Mag. Acc.+14','DMG:+4',}}, augments={'Enh. Mag. eff. dur. +3','STR+4','Mag. Acc.+14','DMG:+4',}},
		sub = "Ammurapi shield",
		ammo = "Regal Gem",
		head = "Telchine Cap",
		neck = "Duelist's torque +2",
	...
	sets.Enhancing.Gain = {
		main ={ name="Colada", augments={'Enh. Mag. eff. dur. +3','STR+4','Mag. Acc.+14','DMG:+4',}},
		sub = "Ammurapi shield",
		ammo = "Regal Gem",
		head = "Telchine Cap",
		neck = "Duelist's torque +2",
	...
	sets.Enfeebling.Acc = {
		...
		back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+10','Weapon skill damage +10%',}},
		legs={ name="Chironic Hose", augments={'Mag. Acc.+29','Haste+1','MND+12','"Mag.Atk.Bns."+6',}},
	...
	sets.WS.Light ={
		...
		back={ name="Sucellos's Cape", augments={'MND+20','Mag. Acc+20 /Mag. Dmg.+20','Mag. Acc.+9','Weapon skill damage +10%',}},
		--ammo = "Pemphredo Tathlum",
		--head="Nyame Helm",
		--neck = "Duelist's torque +2",
		--ear2 = "Malignance Earring",

...
--[#2 Augmented Items & JSE Cape ]--
conveyance = { name="Conveyance Cape", }
conveyanceskill={ name="Conveyance Cape", }
...
campestres_idle={ name="Campestres's Cape", augments={'Pet: M.Acc.+20 Pet: M.Dmg.+20','Pet: Mag. Acc.+10',}} --{ name="Campestres's Cape", augments={'MP+60','Eva.+20 /Mag. Eva.+20','Pet: "Regen"+10',}}
...
apogee_crown_phy={ name="Apogee Crown", augments={'MP+60','Pet: Attack+30','Blood Pact Dmg.+7',}} --need +1
...
merlinic_hands_mab={ name="Merlinic Dastanas", augments={'Pet: "Mag.Atk.Bns."+21','Blood Pact Dmg.+8','Pet: STR+8','Pet: Mag. Acc.+7',}}
...
sets.midcast.Pet.PhysicalBloodPactRage = { --does physical damage only, like pred claws and spinning dive and volt strike
	...
	legs="Enticer's Pants",
	neck="Empath necklace",  --need shulmanu collar
	waist="Incarnation Sash",
	left_ear="Gelos Earring",
	right_ear="Lugalbanda earring",
...
if useall_bp_reduction_gear then 
	...
	sets.precast.BloodPactWard = { --I just stack it all because when I do salvage or a gear slot is locked by a NM it's nice
		...
		ammo="Sancus Sachet", --II -6   --need +1
